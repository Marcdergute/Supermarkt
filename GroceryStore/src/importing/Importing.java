...
public class Importing {
    ...
    public static void  articleGenerate(){
        ...
        articleList.add(new Lebensmittel(dateRandom(), "Groceries", "Wine",2.30, 6.99, 2));
        articleList.add(new Lebensmittel(dateRandom(), "Groceries", "Wine",2.30, 6.99, 2));
        articleList.add(new Haushaltsartikel(0.5, "Household Funds", "Toilet Brush",0.90, 4.99, 0));
        ...
        articleList.add(new Haushaltsartikel(0.01, "Household Funds",  "Toothpaste",0.50, 1.99, 0));
        articleList.add(new Haushaltsartikel(0.01, "Household Funds",  "All-Purpose_Cleaner",1.50, 3.99, 0));
        articleList.add(new Haushaltsartikel(0.01, "Household Funds",  "Glass Cleaner",0.50, 1.99, 0));
        articleList.add(new Haushaltsartikel(0.01, "Household Funds",  "Soap",0.40, 1.49, 0));
        articleList.add(new Haushaltsartikel(0.01, "Household Funds",  "Light Bulb E27 40Watt",3.10, 5.99, 0));
